export default {
  ...
  version:{
    label:'V1.0.0.2',
    title:'V1.0.0.2',
    description:'dCipher wallet is an open-sourced reference implementeation of a web-based non-custodial Ethereum wallet that enable users to trade ERC20 tokens using the dCipher Protocol.',
  ...
  feedback:{
    ...
    email_subject:"dCipher Wallet Feedback",
    email_body:`
## ISSUES \n
...
`,
  ...
  navbar: {
    ...
    refresh_page_tip_description:"Under the consideration of asset safety, dCipher shall not keep any of your wallet information.",
  },
  order: {
    buy: 'Buy',
    sell: 'Sell',
  ...
  home: {
    title: '',
    subtitle: 'An ERC20 Ethereum wallet of dCipher.',
    beta_notification_title:'Can\'t wait to trade with dCipher?',
    beta_notifycation_content: 'dCipher wallet is still in its beta. Test with great caution!'
  },
  buttons: {
  ...
  settings: {
    ...
    save: "Save",
    delete: "Delete",
    addRelay: "Add Custom Network",
    editRelay: "Edit Network",
    chooseRelay: "Choose a Network",
    relayName: "Network Name",
    relayUrl: "Network URL",
    select: "Select"
  },
  trade: {
    ...
    not_allow:"dcipher.IO (dcipher) is still in its beta, please come back later when it's ready for more people to use.",
  ...
  wallet: {
    ...
    loopring_on: "dCipher token on  {project}",
    neo: "NEO",
    qtum: "QTUM",
    ...
    metamask_unlock_refresh_button: 'Done',
    ...
    metamask_unlock_step_refresh_title:'',
    metamask_unlock_step_refresh_content:'',
    ...
    backup: {
      ...
      backup_tip: "dCipher doesn't keep a copy of your privatekey, keystore file, or mnemonic words. Make sure you back up these information immediately.",
    ...
    content_metamask_account_change: "dCipher detected your address in MetaMask has just changed. The old one is closed and the new one will be used instead.",
    ...
    unlock_by_address: 'View Address',
    ...
    unlock_by_cookie_address_notification:'You are in watch-only mode now',
    ...
    metamask_installed_locked_content: 'We detected you have installed MetaMask browser extension and want to unlock your wallet with it, please created or unlocked an account in MetaMask first, then try to unlock with MetaMask',
  },
  demo:{
    badge_title:'Demo Wallet',
    badge_tip:'You are using a demo wallet in the watch-only mode',
    confirm_title: 'Try dCipher with a demo wallet',
